...
namespace TZHSWEET.Entity
{
    ...
    public partial class tbRolePermission: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        public Nullable<long> ModulePermissionID
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("ModulePermissionID", _modulePermissionID);
                    if (!IsDeserializing)
                    {
                        if (tbModulePermission != null && tbModulePermission.ModulePermissionID != value)
                        {
                            tbModulePermission = null;
                        }
                    }
        ...
        [DataMember]
        public tbModulePermission tbModulePermission
        {
            get { return _tbModulePermission; }
            set
            {
                if (!ReferenceEquals(_tbModulePermission, value))
                {
                    var previousValue = _tbModulePermission;
                    _tbModulePermission = value;
                    FixuptbModulePermission(previousValue);
                    OnNavigationPropertyChanged("tbModulePermission");
                }
            }
        }
        private tbModulePermission _tbModulePermission;
        ...
        private void FixuptbModulePermission(tbModulePermission previousValue, bool skipKeys = false)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (previousValue != null && previousValue.tbRolePermissions.Contains(this))
            {
                previousValue.tbRolePermissions.Remove(this);
            }
    
            if (tbModulePermission != null)
            {
                if (!tbModulePermission.tbRolePermissions.Contains(this))
                {
                    tbModulePermission.tbRolePermissions.Add(this);
                }
    
                ModulePermissionID = tbModulePermission.ModulePermissionID;
            }
            else if (!skipKeys)
            {
            ...
            {
                if (ChangeTracker.OriginalValues.ContainsKey("tbModulePermission")
                    && (ChangeTracker.OriginalValues["tbModulePermission"] == tbModulePermission))
                {
                    ChangeTracker.OriginalValues.Remove("tbModulePermission");
                }
                else
                {
                    ChangeTracker.RecordOriginalValue("tbModulePermission", previousValue);
                }
                if (tbModulePermission != null && !tbModulePermission.ChangeTracker.ChangeTrackingEnabled)
                {
                    tbModulePermission.StartTracking();
                }
            }
        }
        ...
        private void FixuptbRole(tbRole previousValue, bool skipKeys = false)
        {
            ...
            if (tbRole != null)
            {
                if (!tbRole.tbRolePermissions.Contains(this))
                {
                    tbRole.tbRolePermissions.Add(this);
                }
