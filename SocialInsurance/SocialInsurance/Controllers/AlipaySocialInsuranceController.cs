...
namespace SocialInsurance.Controllers
{
    public class AlipaySocialInsuranceController : Controller
    {
        ...
        public ActionResult PersonInsuranceStatus(string ID, string IDCard)
        {
            ID = "0500708293";
        ...
        //生育缴费查询
        public ActionResult BirthInsurance(string ID, string IDCard)
        {
            ID = "0500708293";
            IDCard = "441381198208204752";
            var client = new SocialInsuranceService.ShbServClient();
            var temp = client.si090401(ID, IDCard,8,1);
            XElement xoc = XElement.Parse(temp);
        ...
        public ActionResult IdustrialInsurance(string ID,string IDCard,long rows,long cpage )
        {
         var client= new SocialInsuranceService.ShbServClient();
